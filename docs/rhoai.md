...
2) Go to the `Data Science Projects` section and access your application's project named `codegen4-may5-1`.

![image](./images/data-science-projects.png)

3) Access the `workbench` named `codegen4-may5-1-notebook`.
...
5) In the terminal, run `cd codegen4-may5-1` to navigate to your sample app's directory.
